...
\paper {
  % Page = the InDesign type area (A4, margins 20/25/20/18 mm): one PDF page per document page
  ...
  indent = 28\mm
  % Running heads, page numbers and the colophon are InDesign's job
  print-page-number = ##f
  oddHeaderMarkup = ##f  evenHeaderMarkup = ##f
  oddFooterMarkup = ##f  evenFooterMarkup = ##f
  % Same face as the document's Body style
...
\header {
 title = "An den Mond"
 opus = "D 296"
 poet = \markup \column { "Johann Wolfgang von Goethe" \small "(1749-1832)" }
 composer = \markup \column { "Franz Schubert" \small "(1797-1828)" }
% MUTOPIA
 ...
 tagline = ##f
 mutopiatagline = \markup { \override #'(box-padding . 1.0) \override #'(baseline-skip . 2.7) \box \center-column { \small \line { Sheet music from \with-url "http://www.MutopiaProject.org" \line { \teeny www. \hspace #-1.0 MutopiaProject \hspace #-1.0 \teeny .org \hspace #0.5 } • \hspace #0.5 \italic Free to download, with the \italic freedom to distribute, modify and perform. } \line { \small \line { Typeset using \with-url "http://www.LilyPond.org" \line { \teeny www. \hspace #-1.0 LilyPond \hspace #-1.0 \teeny .org } by \maintainer \hspace #-1.0 . \hspace #0.5 Reference: \footer } } \line { \teeny \line { This sheet music has been placed in the public domain by the typesetter, for details see: \hspace #-0.5 \with-url "http://creativecommons.org/licenses/publicdomain" http://creativecommons.org/licenses/publicdomain } } } }
}
