...
`Northwind Studios` and `Vellum & Vine` are fictional. The brand colour is Sidekick's blue (`#38a3ee`); the typeface is **Myriad Pro**, which ships with InDesign on every platform, so the example opens correctly for anyone.
